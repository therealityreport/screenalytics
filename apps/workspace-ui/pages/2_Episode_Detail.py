...
with st.expander("📊 Similarity Scores Guide", expanded=False):
    ...
    **Where these scores appear:**
    - 🟣 **Cast Similarity**: Cluster assignment, identity linking
    - 🔵 **Identity Similarity**: Faces Review ("ID: 87%" badges)
    - 🟢 **Cluster Similarity**: Clustering phase (DBSCAN)
    - 🟠 **Track Similarity**: Detect/track logs (gate splits)
...
with col_cluster:
    ...
    if not local_video_exists:
        ...
        st.info("Faces harvest completed with 0 faces → clustering will immediately finish with 0 identities.")
    elif not detector_face_only:

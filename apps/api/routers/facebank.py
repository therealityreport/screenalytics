...
SEED_MIN_FACE_PIXELS = max(_env_int_nonnegative("SEED_MIN_FACE_PIXELS", 96 * 96), 0)
...
async def upload_seeds(
    ...
    for file in files:
        try:
            ...
            presigned = (
                storage_service.presign_get(display_s3_key, content_type=DISPLAY_MIME) if display_s3_key else None
            )

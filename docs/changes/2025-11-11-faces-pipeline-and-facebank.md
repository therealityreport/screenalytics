...
- Streamlit’s Episode Detail page gained controls for faces + clustering (device/crops/JPEG quality), reusing the shared SSE helper to show MM:SS progress, ETA, and artifact prefixes on completion.
